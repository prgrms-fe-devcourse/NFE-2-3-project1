...
notionWrapSection.addEventListener("input", function (event) {
  ...
  console.log(titleInputEl.value, combinedText);
  editContent(138692, titleInputEl.value, combinedText);
});
...
titleInputEl.addEventListener("input", function (e) {
  ...
  console.log(e.target.value, combinedText);
  editContent(138692, e.target.value, combinedText);
});
